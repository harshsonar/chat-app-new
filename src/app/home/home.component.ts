...
import { NbLayoutModule, NbListModule, NbUserModule, NbChatModule } from '@nebular/theme';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [ButtonModule, NbLayoutModule, NbListModule, NbUserModule, NbChatModule],
